...
public class MailStorageEntryTest {
	...
	public void happyDay() throws MessagingException, IOException {
		...
		SkypeMailMessageFactory gmailMessageFactory = injector.getInstance(SkypeMailMessageFactory.class);
		SkypeMailFolder rootFolderProvider  = injector.getInstance(SkypeMailFolder.class);
		...
		injector.getInstance(MailStorageEntryFactory.class);
		MailStorageEntry gmailStorageEntry =
			new MailStorageEntry(rootFolderProvider, chat, skypeChatDateFormat, gmailMessageFactory);
		
		gmailStorageEntry.store(new SkypeChatSetter(chat));
		
		SkypeMailMessage mimeMessage = gmailStorageEntry.getMessage();
