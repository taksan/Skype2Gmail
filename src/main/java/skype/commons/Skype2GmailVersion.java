...
public class Skype2GmailVersion {
	public static String POM_FULL_PATH = "/META-INF/maven/com.github.taksan/skype2gmail/pom.xml";
	...
	public String getVersion() {
		InputStream pomStream = getClass().getResourceAsStream(POM_FULL_PATH);
